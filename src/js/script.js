...
// Вставка общей суммы в корзине
// $(".cart-modal__total-amount--number").text("$1000");

// Вставка количества товаров в корзине (в главном меню)
// $(".header__cart--quantity").text("2");

// Ячейка с количеством одного наименования товара в корзине
// $(".cart-modal__goods--quantity-number")

// Кнопка "отнять -1 товар"
// $(".cart-modal__goods--quantity-minus")

// Кнопка "добавить +1 товар"
// $(".cart-modal__goods--quantity-plus")